...
> If Ci is the height of child i and Pi is the height of the average parent,
> pick the line that makes the child values Ci and our guesses
...
* **Things to pay attn to:**
  * _confounders_
    ...
    * sometimes detect w/ careful explorati/visualization
